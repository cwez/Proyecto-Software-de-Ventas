...
const CLIENT_ID = '415572449376-ks71dn2e1rc9o1q9olchksf2fmurl48d.apps.googleusercontent.com';
const client = new OAuth2Client(CLIENT_ID);
const mongoose = require('mongoose');
const mongodbUri = 'mongodb://127.0.0.1/Salesoft';
...
app.get('/usuarios', async(req, res)=>{
    ...
    res.send({
            error: true,
            message: 'El usuario no está autorizado NO TOKEN'
        })
